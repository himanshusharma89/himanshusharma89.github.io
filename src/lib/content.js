...
export const techStack = {
	languages: 'Python, Dart, JavaScript, Bash, SQL, Java, Node.js, OpenAPI, REST',
	cloud: 'Kubernetes (GKE), Docker',
	devops: 'GitHub Actions, Jenkins, Firebase, GCS, VS Code, WebStorm',
	data: 'Airflow, Elasticsearch, MongoDB, Redis, Grafana, Sensu, Facets.cloud',
	dx: 'Docs, OSS, Internal Tooling'
};
